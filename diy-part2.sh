...
# 复制 firmware 包到 package/firmware/
cp -a $GITHUB_WORKSPACE/configfiles/packages/jp-tvbox-firmware package/firmware/
cp -a $GITHUB_WORKSPACE/configfiles/packages/panther-x2-firmware package/firmware/
# 复制内核模块包到 package/kernel/
cp -a $GITHUB_WORKSPACE/configfiles/packages/dtmbusb package/kernel/
